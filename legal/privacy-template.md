...
- Cloudflare (hosting, DDoS protection, analytics)
- Better Auth (authentication sessions stored in our own D1 database)
- Resend (transactional email — Phase 2)
- Cloudflare Turnstile (bot prevention — privacy-preserving)
